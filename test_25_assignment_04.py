...
Read the comments all fill up the code. If the spec is not clear, read the tests below.
'''
...
# Fill up the negate function which negates the output of the passed
