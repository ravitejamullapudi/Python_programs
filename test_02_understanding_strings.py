...
def test_string_combine():
    ...
    hello = "Hello World"
    bye = "Goodbye moon"
    assert " ".join((hello[-6:] + ' ' + bye[0:7]).split()[::-1]) == "Goodbye World" # join
...
- -1 index is from last
- functions like join(), split
- format() and need to enclose the multiple terms in parenthesis like ( 'c' in 'apple' )
"""
