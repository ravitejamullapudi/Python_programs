...
def test_numbers_string_to_int():
    ...
    assert (15*16+15) == int("FF", 16)
    assert (7*8+7) == int("77", 8)
...
- need to keep parenthesis for the results in int("FF",16)
- need place 0b for binary and 0x for hex values
- long is very high in python unlike c
"""
